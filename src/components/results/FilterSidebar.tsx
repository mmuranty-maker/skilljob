...
export function FilterSidebar({ filters, onChange, onOpenQuiz, className = "" }: FilterSidebarProps) {
  ...
  return (
    <aside className={`bg-white border-r border-[hsl(220,13%,91%)] p-5 flex flex-col ${className}`}>
      ...
      {/* Quiz CTA card — pinned at the bottom of the rail */}
      {onOpenQuiz && (
        <div className="mt-6 pt-5 border-t border-[hsl(220,13%,91%)]">
